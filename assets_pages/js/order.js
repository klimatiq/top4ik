$(function() {
	...
	$('form.main-order-form').submit(function(e) {
        ...
        if (phone.length) {
            ...
            let testMobileAlert = urlParams.get('testMobileAlert');

            if (phoneNumber.length < phoneMinLength){
                return alert(phoneError5);
            }

            if (testMobileAlert != null && phoneNumberClear.length == 11 && phoneNumberClear.charAt(0) == 7 && phoneNumberClear.charAt(1) != 9) {
